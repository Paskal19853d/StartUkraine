...
>
> **Пов'язана документація:** [CLAUDE.md](CLAUDE.md) (секція 6 «Автентифікація і безпека», секція 11 «Правила роботи») · [MASTER_GUIDE.md](MASTER_GUIDE.md) · [SESSION_CHANGES.md](SESSION_CHANGES.md) (безпека нових модулів останньої сесії — cookie, rate-limit, валідація)
