...
>
> **Пов'язана документація:** [CLAUDE.md](CLAUDE.md) (актуальний головний довідник, читати ПЕРШИМ) · [DATABASE.md](DATABASE.md) (схема БД) · [SECURITY_RULES.md](SECURITY_RULES.md) (безпека) · [SESSION_CHANGES.md](SESSION_CHANGES.md) (чекліст деплою останньої сесії)
